...
function StockMarketCard() {
  ...
  return (
    <div
      className="card mb-6 text-bg-light border-dark"
      style={{ backgroundColor: "#EAD6CD" }}
    >
      <div className="card-header border-dark">Stock Market Update</div>
      <div className="card-body">
        {stockMarketsData === null ? (
          <>
            <div>
            ...
            {stockMarketsData.map((market) => {
              return (
                <div key={market.exchange}>
                  <a
                    href={`https://finance.yahoo.com/quote/%5E${market.symbol.slice(
                      1
                    )}`}
                    className={
                      market.regularMarketChangePercent > 0
                        ? "list-group-item list-group-item-action flex-fill align-items-start list-group-item-success"
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-2">
                          ...
                          >
                            ...
                            {market.regularMarketChangePercent < 0
                              ? market.regularMarketChangePercent.toFixed(2) *
                                -1
                              : market.regularMarketChangePercent.toFixed(2)}
                            %
                          </span>
